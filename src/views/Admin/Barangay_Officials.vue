    ...
    <tbody>
     ...
     >
      ...
      >
       ...
       <!-- <button class="btn btn-danger" v-b-modal.modal-delete @click="setOfficial(official)">
   ...
   <div class="row">
    ...
    <div class="form-group">
     ...
     <div v-if="this.errors.fullname">
      <label style="color: red; font-weight: 500">{{ this.errors.fullname[0] }}</label>
     </div>
    </div>
   </div>
   <div class="row">
    <div class="form-group">
     ...
     <div v-if="this.errors.chairmanship_id">
      <label style="color: red; font-weight: 500">{{ this.errors.chairmanship_id[0] }}</label>
     </div>
    </div>
   </div>
   <div class="row">
    <div class="form-group">
     ...
     <div v-if="this.errors.position_id">
      <label style="color: red; font-weight: 500">{{ this.errors.position_id[0] }}</label>
     </div>
    </div>
   </div>
   <div
    class="row"
    v-if="position_id == 4 || position_id == 5"
   >
    <div class="form-group">
     <label
      for="OFFICIAL"
   ...
   <div class="row">
    <div class="form-group">
     ...
     <div v-if="this.errors.term_start">
      <label style="color: red; font-weight: 500">{{ this.errors.term_start[0] }}</label>
     </div>
    </div>
   </div>
   <div class="row">
    <div class="form-group">
     ...
     <div v-if="this.errors.term_end">
      <label style="color: red; font-weight: 500">{{ this.errors.term_end[0] }}</label>
     </div>
    </div>
   </div>
   <div class="row">
    <div class="form-group">
     ...
     <div v-if="this.errors.status">
      <label style="color: red; font-weight: 500">{{ this.errors.status[0] }}</label>
     </div>
    </div>
   </div>
  </b-modal>
...
export default {
 ...
 methods: {
  ...
  async fetchOfficial() {
   this.loading = true;
   await axios
    .get(`/barangay_officals?page=${this.currentPage}&search=${this.search}`)
    .then((response) => {
  ...
  async deleteOfficial() {
   ...
   //     remember_token: localStorage.getItem("token"),
   // };
   await axios.delete(`/barangay_officals/${this.id}?remember_token=${localStorage.getItem("token")}`).then((response) => {
