 ...
 <div class="container">
  ...
  >
   <div
    ...
    v-if="this.identification_img != null && this.identifation != null"
   >
    <img
     :src="'http://127.0.0.1:8000/identification/' + this.identification_img"
     height="300"
    />
    <h5
...
export default {
 ...
 methods: {
  ...
  async fetchOfficial() {
   ...
   await axios.get(`/pending-residents?page=${this.currentPage}&search=${this.search}`).then((response) => {
