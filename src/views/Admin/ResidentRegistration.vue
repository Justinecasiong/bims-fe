  ...
  <div class="container">
      ...
      <div class="row">
        ...
        <div class="col">
          ...
          <div class="row">
            ...
            <div class="col-sm-4">
              <div class="form-group">
                <label for="first-name" class="control-label"> Sex: </label>
                <select
                  disabled
                  class="form-select"
                  name="sex"
          ...
          <div class="row">
            ...
            <div class="col-sm-4">
              <div class="form-group">
                <label for="contact-number" class="control-label">
                  Contact Number:
                </label>
                <input
                  readonly
    ...
    >
      ...
      >
        <img
          :src="
            'http://13.229.52.4:8080/identification/' + this.identification_img
          "
          height="300"
        />
      ...
      <div
        ...
        v-if="this.identification_img == null || this.identifation == null"
      >
        <h4 style="font-style: italic" class="fw-bold mt-3">No ID uploaded!</h4>
      </div>
    </b-modal>
  </div>
</template>
