      ...
      <div class="col-sm-4">
       <div class="form-group">
        ...
        <div v-if="this.errors.place_of_birth">
         <label style="color: red; font-weight: 500">{{ this.errors.place_of_birth[0] }}</label>
        </div>
       </div>
      </div>
      <div class="col-sm-4">
      ...
      <div class="col-sm-4">
       <div class="form-group">
        ...
        <div v-if="this.errors.voter_status">
         <label style="color: red; font-weight: 500">{{ this.errors.voter_status[0] }}</label>
        </div>
       </div>
      </div>
      <div class="col-sm-4">
       <div class="form-group">
        ...
        <div v-if="this.errors.identified_as">
         <label style="color: red; font-weight: 500">{{ this.errors.identified_as[0] }}</label>
        </div>
       </div>
      </div>
     </div>
      ...
      <div class="col-sm-4">
       <div class="form-group">
        ...
        <div v-if="this.errors.contact_num">
         <label style="color: red; font-weight: 500">{{ this.errors.contact_num[0] }}</label>
        </div>
       </div>
      </div>
      <div class="col-sm-4">
...
export default {
 ...
 computed: {
  ...
  fetchResidents() {
   return this.residents.filter((data) => {
    return data.status && data.zone_id.toString().match(this.search_zone) && data.status.match("Approved");
   });
  },
 ...
 methods: {
  ...
  async deleteResident() {
   const res = await this.$store.dispatch("RESIDENT/DELETE_RESIDENT", this.id);
