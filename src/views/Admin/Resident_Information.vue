<template>
  <div class="container">
    <div class="page-header">
      ...
      <div class="row" v-if="permission != 'admin' && permission != 'resident'">
    ...
    <div class="table-container table-responsive-xxl shadow">
      ...
      >
        ...
        <tbody>
          <tr v-for="(resident, index) in fetchResidents" :key="resident.id">
          ...
          <div class="row">
            ...
            <div class="col-sm-4">
              <div class="form-group">
                ...
                <select class="form-select" name="sex" id="sex" v-model="sex">
