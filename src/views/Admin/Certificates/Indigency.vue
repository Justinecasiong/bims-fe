        ...
        <div class="row">
          <div class="col-lg-3 officials">
            <div class="container-box">
              ...
              <h6>
                {{ this.chairman[0].position.position_description }}
              </h6>
              <br />
              <li
              ...
              >
                ...
                <h6 style="font-style: italic">
                  {{ kagawad.chairmanship.chairmanship_description }}
                </h6>
                <br />
              </li>
              <li
              ...
              >
                ...
                <h6>
                  {{ sk_chairman.position.position_description }}
                </h6>
                <h6 style="font-style: italic">
                  {{ sk_chairman.chairmanship.chairmanship_description }}
                </h6>
                <br />
              </li>
            </div>
          ...
          <div class="col contents">
            <div class="header">
              <h4 style="font-size: 18pt">OFFICE OF THE BARANGAY CAPTAIN</h4>
              <br />
            ...
            <h4>
              ...
              <b
                ...
                {{ this.residents.civil_status.toUpperCase() }}</b
              >
              and is a bona fide resident of Sto. Nino Extension, Barangay 6-A, Tacloban City with Postal address
            ...
            <h4>
              ...
              above-mentioned name belongs to an Indigent Family in this
              barangay with no income generating business or properties.
            </h4>
            <br />
            <h4>
              &nbsp;&nbsp; &nbsp; &nbsp; THIS CERTIFICATION is hereby issued to
              the above-named person for <b>{{ this.purpose }}</b>
            </h4>
            <br />
            <h4>
              ISSUED this <b>{{ date.toUpperCase() }}</b> at the Office of the
              Punong Barangay, <b>STO. NIÑO EXTENSION, BARANGAY 6-A</b>,
              Philippines
            </h4>
