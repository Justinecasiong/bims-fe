...
import Household from "../views/Admin/Household.vue";
import Family_Records from "../views/Admin/Family_Records.vue";
import Environment from "../views/Admin/Environment.vue";
import ChildInfo from "../views/Admin/ChildInfo.vue";
import Business_Establishments from "../views/Admin/Business_Establishments.vue";
import OPT_Plus from "../views/Admin/OPT_Plus.vue";
import Summon_Letter from "../views/Admin/Summon_Letter.vue";
import Health_Services from "../views/Admin/Health_Services.vue";
...
const routes = [
 ...
 },
 {
  ...
  children: [
   ...
   {
    path: "/business_establishments",
    name: "Business_Establishments",
    component: Business_Establishments,
   },
   {
    path: "/opt_plus",
    name: "OPT_Plus",
